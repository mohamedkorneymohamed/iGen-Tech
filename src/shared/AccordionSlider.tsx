...
export const AccordionSlider = ({ services }: { services: Service[] }) => {
    ...
    return (
        <>
            <div className="w-full flex flex-row items-center justify-center gap-2 select-none">
                {/* Panels */}
                <div className="flex flex-row h-[80vh] w-full items-center gap-2 justify-center">
                        ...
                        return (
                            ...
                            >
                                <AnimatePresence mode="wait">
                                    {idx === active ? (
                                        <motion.div
                                            key={service.service_title + "-content"}
                                        ...
                                        >
                                            <div>
                                                ...
                                                <p dangerouslySetInnerHTML={{ __html: service.service_description }} className="text-base font-regular max-w-[464px] leading-[1.6] text-[#212C66] ">
                                                </p>
                                            </div>
                                        ...
                                        <motion.div
                                                key={service.service_title + "-label"}
